...
from orm.xeeffyy.public.class_dimension import class_dimension
class cms_dimension(class_dimension):
    def __init__(self, cnx = None):
        class_dimension.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_dimension())
