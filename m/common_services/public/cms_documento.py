...
from orm.xeeffyy.public.class_documento import class_documento
class cms_documento(class_documento):
    def __init__(self, cnx = None):
        class_documento.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_documento())
