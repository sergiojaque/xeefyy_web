...
from orm.xeeffyy.public.class_escenario import class_escenario
class cms_escenario(class_escenario):
    def __init__(self, cnx = None):
        class_escenario.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_escenario())
