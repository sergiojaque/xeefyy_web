...
from orm.xeeffyy.public.class_qry_data import class_qry_data
class cms_qry_data(class_qry_data):
    def __init__(self, cnx = None):
        class_qry_data.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_qry_data())
