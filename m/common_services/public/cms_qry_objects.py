...
from orm.xeeffyy.public.class_qry_objects import class_qry_objects
class cms_qry_objects(class_qry_objects):
    def __init__(self, cnx = None):
        class_qry_objects.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_qry_objects())
