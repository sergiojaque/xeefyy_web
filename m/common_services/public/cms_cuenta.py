...
from orm.xeeffyy.public.class_cuenta import class_cuenta
class cms_cuenta(class_cuenta):
    def __init__(self, cnx = None):
        class_cuenta.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_cuenta())
