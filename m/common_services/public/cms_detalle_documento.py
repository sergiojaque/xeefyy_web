...
from orm.xeeffyy.public.class_detalle_documento import class_detalle_documento
class cms_detalle_documento(class_detalle_documento):
    def __init__(self, cnx = None):
        class_detalle_documento.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_detalle_documento())
