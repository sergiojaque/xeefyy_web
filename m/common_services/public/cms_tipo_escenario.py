...
from orm.xeeffyy.public.class_tipo_escenario import class_tipo_escenario
class cms_tipo_escenario(class_tipo_escenario):
    def __init__(self, cnx = None):
        class_tipo_escenario.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_tipo_escenario())
