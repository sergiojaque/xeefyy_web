...
from orm.xeeffyy.public.class_contexto import class_contexto
class cms_contexto(class_contexto):
    def __init__(self, cnx = None):
        class_contexto.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_contexto())
