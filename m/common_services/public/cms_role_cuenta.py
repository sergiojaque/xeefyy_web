...
from orm.xeeffyy.public.class_role_cuenta import class_role_cuenta
class cms_role_cuenta(class_role_cuenta):
    def __init__(self, cnx = None):
        class_role_cuenta.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_role_cuenta())
