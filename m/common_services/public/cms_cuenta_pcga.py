...
from orm.xeeffyy.public.class_cuenta_pcga import class_cuenta_pcga
class cms_cuenta_pcga(class_cuenta_pcga):
    def __init__(self, cnx = None):
        class_cuenta_pcga.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_cuenta_pcga())
