...
from orm.xeeffyy.public.class_tipo_cuenta import class_tipo_cuenta
class cms_tipo_cuenta(class_tipo_cuenta):
    def __init__(self, cnx = None):
        class_tipo_cuenta.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_tipo_cuenta())
