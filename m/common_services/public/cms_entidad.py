...
from orm.xeeffyy.public.class_entidad import class_entidad
class cms_entidad(class_entidad):
    def __init__(self, cnx = None):
        class_entidad.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_entidad())
