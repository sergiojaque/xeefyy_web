...
from orm.xeeffyy.public.class_context_escenarios import class_context_escenarios
class cms_context_escenarios(class_context_escenarios):
    def __init__(self, cnx = None):
        class_context_escenarios.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_context_escenarios())
