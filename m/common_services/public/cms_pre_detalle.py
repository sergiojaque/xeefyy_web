...
from orm.xeeffyy.public.class_pre_detalle import class_pre_detalle
class cms_pre_detalle(class_pre_detalle):
    def __init__(self, cnx = None):
        class_pre_detalle.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_pre_detalle())
