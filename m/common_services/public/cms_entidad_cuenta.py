...
from orm.xeeffyy.public.class_entidad_cuenta import class_entidad_cuenta
class cms_entidad_cuenta(class_entidad_cuenta):
    def __init__(self, cnx = None):
        class_entidad_cuenta.__init__(self, cnx = cnx)
        
    def __unicode__(self):
        return str(self.get_desc_entidad_cuenta())
